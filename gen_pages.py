...
def greedy_script(fname):
    rt,ext = fname.splitext(fname)
    parts = rt.split('_')
    prop_clusters,
    return '''
<!DOCTYPE html>
...
// load data
//
d3.csv("data/embed/{}", function(error, data) {{
...
'''.format(nickname,k_type,splitid,quantile,perfect,even,fname)

def arch_script(fname):
    return '''
<!DOCTYPE html>
<html>
<meta charset="utf-8">
