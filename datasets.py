...
New Concept : splitid 0 always means all the classes are known.
'''
import os
import pickle
...
voc2008 = [ {
    'known' : ['car','chair','diningtable','sheep','sofa','aeroplane','bicycle','bird','boat','bottle','bus','cat','cow','dog', 'horse','motorbike','person','pottedplant','train','tvmonitor'],
    'unknown' : [],
    'significance' : "all classes are known"
}, {
...
coco = [{'known' : [u'airplane', u'apple', u'banana', u'baseball bat', u'bear', u'bed', u'bench', u'bicycle', u'boat', u'book', u'bottle', u'bowl', u'broccoli', u'bus', u'cake', u'car', u'carrot', u'cat', u'chair', u'clock', u'couch', u'cow', u'cup', u'dining table', u'dog', u'donut', u'elephant', u'fire hydrant', u'fork', u'frisbee', u'giraffe', u'hair drier', u'horse', u'hot dog', u'keyboard', u'kite', u'knife', u'laptop', u'microwave', u'motorcycle', u'mouse', u'oven', u'parking meter', u'person', u'pizza', u'potted plant', u'refrigerator', u'remote', u'sandwich', u'scissors', u'sheep', u'sink', u'skateboard', u'skis', u'snowboard', u'spoon', u'sports ball', u'stop sign', u'suitcase', u'teddy bear', u'tennis racket', u'toaster', u'toilet', u'toothbrush', u'traffic light', u'train', u'truck', u'tv', u'umbrella', u'vase', u'wine glass', u'zebra',u'baseball glove', u'orange', u'surfboard', u'handbag', u'backpack', u'bird', u'cell phone', u'tie'],
          'unknown' : [],
          'significance' : "all classes known" },
        {'known' : [u'baseball glove', u'orange', u'surfboard', u'handbag', u'backpack', u'bird', u'cell phone', u'tie'],
    ...
    {'known' : [u'cell phone', u'frisbee', u'fire hydrant', u'toaster', u'apple', u'person', u'bicycle', u'toothbrush', u'donut', u'broccoli', u'cat', u'toilet', u'airplane', u'bed', u'tennis racket', u'sandwich', u'baseball bat', u'parking meter', u'kite', u'banana', u'sink', u'bottle', u'bench', u'zebra', u'remote', u'oven', u'elephant', u'knife', u'cow', u'motorcycle', u'refrigerator', u'dog', u'tie', u'scissors', u'microwave', u'sheep', u'vase', u'snowboard', u'cake', u'backpack', u'truck', u'horse', u'skis', u'umbrella', u'sports ball', u'suitcase', u'bird', u'baseball glove', u'couch', u'car', u'skateboard', u'cup', u'handbag', u'tv', u'mouse', u'chair', u'hot dog', u'stop sign', u'hair drier', u'train', u'pizza', u'orange', u'potted plant', u'book', u'fork', u'teddy bear', u'wine glass', u'bear', u'giraffe', u'laptop', u'boat', u'bus',u'bowl', u'carrot', u'clock', u'dining table', u'keyboard', u'spoon', u'surfboard', u'traffic light'],
    'unknown' : [],
    'significance' : "Split 10: All the classes are known." 
},
]



ytbb = [{'known': ['bear', 'bicycle', 'bird', 'horse', 'person', 'potted plant'],
         'unknown': ['airplane', 'boat', 'bus', 'car', 'cat', 'cow', 'dog', 'elephant', 'giraffe', 'knife', 'motorcycle', 'skateboard', 'toilet', 'train', 'truck', 'umbrella', 'zebra']},
        {'known': ['airplane', 'bicycle', 'bus', 'giraffe', 'knife', 'motorcycle', 'toilet', 'train', 'truck', 'umbrella'],
         'unknown': [ 'bear', 'bird', 'boat', 'car', 'cat', 'cow', 'dog', 'elephant', 'horse', 'person', 'potted plant', 'skateboard', 'zebra' ]},
        {'known': [ 'airplane', 'bicycle', 'bird', 'boat', 'car', 'cat', 'cow', 'person', 'skateboard', 'toilet', 'train', 'truck', 'umbrella', 'zebra' ],
         'unknown': [ 'bear', 'bus', 'dog', 'elephant', 'giraffe', 'horse', 'knife', 'motorcycle', 'potted plant' ]},
        {'known': [ 'bear', 'bicycle', 'bird', 'boat', 'bus', 'car', 'cat', 'dog', 'elephant', 'giraffe', 'horse', 'knife', 'person', 'skateboard', 'toilet', 'train', 'truck', 'zebra' ],
         'unknown': [ 'airplane', 'cow', 'motorcycle', 'potted plant', 'umbrella' ]}]
